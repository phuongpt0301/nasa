            ...
            <Modal backdrop="static" isOpen={dataList.isShow} className="modal-item">
                <ModalBody>
                    <div className="header-area">
                        <h1 className="title">
                        { 
                            (dataList.currentItem && dataList.currentItem.data && dataList.currentItem.data.length > 0 && dataList.currentItem.data[0].title ) 
                            ? dataList.currentItem.data[0].title : 'Unknown'
                        }
                        </h1>
